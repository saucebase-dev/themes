...
<template>
    <Popover v-model:open="isOpen">
        ...
        <PopoverContent
            ...
            align="end"
        >
            <!-- Header: logo + title + view toggle -->
            <div class="flex items-center gap-2 px-3 py-2">
                <IconTailwind
                    class="size-5 shrink-0 text-sky-400"
                    aria-hidden="true"
                />
                <span class="text-foreground flex-1 text-sm font-semibold">
                    Tailwind v4
                </span>
                <div
            ...
            <!-- Search -->
            <div class="border-border border-y px-3 py-2">
                <SearchInput
                    v-model="search"
            ...
            <ScrollArea class="h-60">
                <div class="p-2">
                    <template v-for="fam in filtered" :key="fam.key">
                        ...
                        <div
                            v-else
                            class="mb-1 grid grid-cols-11 gap-0.5 px-1 py-0.5"
                        >
